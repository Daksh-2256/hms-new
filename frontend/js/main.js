function login() {
  ...
  const url =
    role === "doctor"
      ? "https://hms-new-production.up.railway.app/api/doctors/login"
      : "https://hms-new-production.up.railway.app/api/users/login";
...
function registerUser() {
  ...
  fetch(
    "https://hms-new-production.up.railway.app/api/users/register",
    {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
